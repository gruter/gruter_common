...
public class CommonHttpServer implements FilterContainer {
   ...
   */
  public CommonHttpServer(String webContextPath, String bindAddress, int port, boolean findPort) throws IOException {
    ...
    //webAppContext.addServlet(MonitorControllerServlet.class, "/monitor");
